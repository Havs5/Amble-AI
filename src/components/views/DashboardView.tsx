...
export function DashboardView({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="shrink-0 max-w-[1100px] w-full mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 pb-4" style={{ animation: 'entrance-stagger 0.5s ease-out both' }}>
        ...
        {user ? (
          <div
            className="flex-1 min-h-0 max-w-[1100px] w-full mx-auto px-4 sm:px-6 lg:px-8 pb-4"
          ...
          <div
            className="shrink-0 max-w-[1100px] w-full mx-auto px-4 sm:px-6 lg:px-8 pb-4"
            style={{ animation: 'entrance-stagger 0.6s ease-out both' }}
          >
